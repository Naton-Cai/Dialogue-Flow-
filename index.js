...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
  ...
  function welcome(agent) {
    agent.add(`Hello, I am CineMark, I am here to find you a theater to watch a movie. Tell me a movie and, if you want, a theater you want to watch it at.`);
  }
  ...
  function MovieTheaterMatch(agent) {
    ...
    const theaterEntry = parameters.TheaterName.find(entry =>
      Object.values(entry).some(value => value !== "")
    );
    const MovieTheater = theaterEntry ? Object.values(theaterEntry).find(value => value !== "") : "";
